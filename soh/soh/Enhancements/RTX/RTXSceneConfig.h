...
// RTX-enabled scenes: Kokiri Forest, Hyrule Field, Zora's Domain, Zora's River.
// The remaining scenes are listed for future expansion and scene-transition logic.

/**
 * SceneConverter.cpp — Phase 9 compatibility source file
 *
 * This file is referenced by the Phase 9 build system plan (RTX_PLAN.md §9.1)
 * under the name "SceneConverter.cpp". The actual N64 display list geometry
 * extraction and scene conversion logic lives in SceneGeometryExtractor.cpp.
 * This file provides a compilation unit for the SceneConverter name used in the plan.
 *
...
// The actual scene conversion implementation is in SceneGeometryExtractor.cpp/.h.

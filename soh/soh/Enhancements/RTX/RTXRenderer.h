...
private:
    ...
    // Room geometry (will be populated by geometry extractor in Phase 2)
    // std::vector<RoomGeometry> m_roomGeometry;

    // Acceleration structures (will be built in Phase 3)
    // std::unique_ptr<AccelerationStructure> m_accelerationStructure;

    // Texture manager (will be created in Phase 6)
